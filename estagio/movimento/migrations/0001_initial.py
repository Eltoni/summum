    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(unique=True, max_length=255, verbose_name='Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorias', models.ManyToManyField(to='movimento.Categoria', null=True, verbose_name='Categoria', blank=True)),
            ...
            options={
                ...
                'permissions': (('visualizar_rel_produtos_esgotando', 'Ver relatorio de produtos esgotando em estoque'), ('visualizar_rel_debitos_creditos_diario', 'Ver relatorio de debitos e creditos diarios'), ('visualizar_relatorios', 'Ver relatorios')),
            },
            bases=(models.Model,),
        ),
    ]
