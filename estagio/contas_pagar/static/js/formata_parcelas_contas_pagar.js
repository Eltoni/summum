$(document).ready(function(){
    ...
    $tableRows.each(function(n) {
        var valorPago = $(this).find('.field-link_pagamentos_parcela').text();
        if (valorPago > 0.00){
    ...
    $tableRows.each(function(n) {
        ...
        var valorPago = parseFloat($(this).find('.field-link_pagamentos_parcela').text());
