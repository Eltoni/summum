    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao', models.CharField(blank=True, verbose_name='Descrição', max_length=250)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('multa', models.DecimalField(blank=True, max_digits=7, verbose_name='Taxa de multa (%)', decimal_places=4, null=True)),
                ('juros', models.DecimalField(blank=True, verbose_name='Taxa de juros (%)', null=True, help_text='Juros que serão calculados diariamente.', decimal_places=4, max_digits=7)),
