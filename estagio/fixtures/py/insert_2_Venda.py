...
def calcula_valor_total_item_venda(quantidade, valor_unitario, desconto):
    ...
    while not data >= data_atual:
        ...
        for i in range(random.randint(0,10)):
            ...
            for ic in range(random.randint(1,15)):
                ...
                valor_total = calcula_valor_total_item_venda(quantidade, valor_unitario, percentual_desconto)
